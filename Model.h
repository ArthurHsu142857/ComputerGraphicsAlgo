...
public:
	...
	const std::string CubeMapFace[6] {
		"px.jpg", "nx.jpg",	"py.jpg", "ny.jpg",	"nz.jpg", "pz.jpg"
	};
...
private:
	...
	static constexpr float smSkyboxVertices[] = {
		-1.0f,  1.0f, -1.0f,
        -1.0f, -1.0f, -1.0f,
         1.0f, -1.0f, -1.0f,
         1.0f, -1.0f, -1.0f,
	...
	static constexpr unsigned int smSkyboxIndices[] = {
		0, 1, 2,
		3, 4, 5,
...
private:
	...
	void BuildQuad();
	void BuildSkybox(const std::string path);
	...
	unsigned int CubeMapTextureFromFile(const std::string& directory, bool gamma = false);
	Color LoadMaterialColors(aiMaterial* mat);
	Mesh ProcessQuadMesh();
	Mesh ProcessSkyboxMesh();
